# Visual Language Reference — patterns, shapes, color, aesthetics, JSON structure

Read this before Step 5 (Generate JSON) — it's the mechanical "how to actually draw" detail, not
needed during Steps 1-4 (understanding, pattern mapping, variety check, sketching the flow).
